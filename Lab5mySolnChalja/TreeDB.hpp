...
private:
    ...
    TreeNode* root;
    int probesCount;
    bool insertRecursionFunction(TreeNode *newNodePtr, TreeNode *current);
    void printTreeHelper(TreeNode *cur);
    DBentry* findRecursionFunction(string name, TreeNode* current);
...
public:
   ...
   // frienstd::ostreamam& operator<< (ostream& out, const TreeDB& rhs);
//};
...
//ostream& operator<< (ostream& out, TreeNode* rhs);#endif
};
#endif
